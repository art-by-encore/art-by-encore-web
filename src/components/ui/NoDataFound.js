...
const NoDataFound = (props) => {
    ...
    return (
        <div className=''>
            <div className='flex flex-col justify-center gap-[30px] items-center h-[70svh]'>
                ...
                <p className='text-white font-card-title text-center'>Looks empty right now.<br /> Check back soon!</p>
            </div>
        </div>
    )
}
